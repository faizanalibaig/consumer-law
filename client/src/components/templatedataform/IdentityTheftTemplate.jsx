...
import {useNavigate} from 'react-router-dom'
   ...
   import { firstname, 
        ...
        sign,
        postalcode,
        dob,} from '../../slice/identitytheftslice';

const IdentityTheftTemplate = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid) {
      ...
      navigate('/form/template/identity-theft-letter')
    } else {
      setErrors((prevErrors) => ({
        ...prevErrors,
  ...
  return (
    <div className='h-auto flex flex-col items-center'>
      <section className='px-5 sm:px-0 sm:pt-10 lg:pt-0'>
        <h1 className='text-[28px] sm:text-[38px] lg:text-[45px] xl:text-[50px] font-bold py-5 sm:py-10 sm:px-[120px] lg:px-[150px] xl:px-[300px] sm:text-center'>Fill Out The Form For Identity Theft Letter FCRA</h1>
      </section>
      <section className='flex flex-col sm:gap-5 w-[90%] lg:w-[80%]'>
        <form onSubmit={handleSubmit}>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-1 w-full gap-3 py-5'>
          <div className='flex flex-col gap-2'>
            <input
              type='number'
              name='number'
...
export default IdentityTheftTemplate;
