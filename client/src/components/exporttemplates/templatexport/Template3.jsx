...
import ExportWord from "../word/Word1";
import IDENTITY_THEFT_AFFIDIVAT from "../../../templates/IDENTITY_THEFT_AFFIDIVAT";
import toast, { Toaster } from "react-hot-toast";
import { LogicHandler } from "../LogicHandler";
import { useNavigate } from "react-router-dom";


const Template3Export = () => {
  ...
  return (
    <div>
      <div ref={componentRef} className="main-document">
        <IDENTITY_THEFT_AFFIDIVAT />
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3  gap-3 w-full px-[1.5rem] sm:px-[5rem] lg:px-[8rem] xl:px-[17rem] pb-[5rem]">
        <div className="">
          <ExportWord />
        </div>
        <div>
...
export default Template3Export;
