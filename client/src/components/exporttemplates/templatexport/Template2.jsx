...
import IDENTITY_THEFT_LETTER_FCRA from "../../../templates/IDENTITY_THEFT_LETTER_FCRA";
import Export2Word from "../word/Word2";
import { LogicHandler } from "../LogicHandler";
import toast, { Toaster } from "react-hot-toast";
import { useNavigate } from "react-router-dom";

const Template2Export = () => {
  ...
  return (
    <div>
      <div ref={componentRef} className="main-document">
        <IDENTITY_THEFT_LETTER_FCRA />
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3  gap-3 w-full px-[1.5rem] sm:px-[5rem] lg:px-[8rem] xl:px-[17rem] pb-10">
        <div className="">
          <Export2Word />
        </div>
        {/* <div>
...
export default Template2Export;
