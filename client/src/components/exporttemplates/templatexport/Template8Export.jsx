...
import ACCOUNTS_DOCUMENT from "../../../templates/ACCOUNTS_DOCUMENT";
import Export8Word from "../word/Word8";

import { LogicHandler } from "../LogicHandler";
import toast, { Toaster } from "react-hot-toast";
import { useNavigate } from "react-router-dom";

const Template8Export = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3  gap-3 w-full px-[1.5rem] sm:px-[5rem] lg:px-[17rem] pb-[5rem]">
        ...
        {/* <div>
      <button onClick={printContent}  className="h-[60px] bg-[#688deb] w-full text-white font-semibold">
        Print</button>
    </div> */}
        <button
          onClick={async () => {
...
export default Template8Export;
